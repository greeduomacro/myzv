...
?>
<div id="guild-war-rankings" style="display: table;">
	<div style="display: table-header-group;">
		...
		<div style="display: table-cell; text-align: center; width: auto;">Wars</div>
	</tr><?
	$charq = $db->query( "SELECT guild_id, guild_abbreviation, guild_name, guild_wars FROM myrunuo_guilds ORDER BY guild_wars DESC LIMIT $TOP_COUNT" );
	$i = 0;
	...
	<div style="display: table-row;">
		...
		<div style="display: table-cell; text-align: center; width: auto;"><? echo $char['guild_wars']; ?></div>
	</div><?
	} ?>
</div>
